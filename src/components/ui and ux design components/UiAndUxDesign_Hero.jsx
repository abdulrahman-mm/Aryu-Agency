...
import uiuxdesign_hero_image from '../../assets/uiuxdesign_hero_image.svg'
  ...
  return (
    <section className="px-5 py-5 sm:px-10 sm:py-10  md:px-20  md:py-20 ">
      <div className="flex flex-col-reverse gap-5 md:flex-row items-center md:justify-between">
        <div className="flex uiux-design-text flex-col basis-full md:basis-[60%] text-center md:text-left">
        ...
        <img src={uiuxdesign_hero_image} alt="" className="uiux-design-circle"/>
      </div>
      ...
      <div className="flex justify-center items-center flex-wrap   my-16">
        {[
          ...
          <p
            key={index}
            className="px-4 py-4 uiuxanimated-item hover:text-violet-800 hover:border-violet-800 cursor-pointer text-gray-600 border border-gray-300 rounded-3xl text-xl"
          >
            {text}
          </p>
        ))}
...
export default UiAndUxDesign_Hero;

import digital_marketing_hero_image from '../../assets/digital_marketing_hero_image.svg'
...
const Digital_Marketing_Hero = () => {
  ...
  useEffect(() => {
    ...
    gsap.fromTo(
      ".digital-marketing-animated-item",
      {
        opacity: 0,
        y: 50,
      },
  ...
  return (
    <section className="px-5 py-5 sm:px-10 sm:py-10  md:px-20  md:py-20 ">
      <div className="flex flex-col-reverse gap-5 md:flex-row items-center md:justify-between">
        <div className="flex digital-marketing-text flex-col basis-full md:basis-[60%] text-center md:text-left">
          ...
          <p className="text-2xl md:text-4xl lg:text-7xl">
            ...
            <span className="font-semibold text-purple-900">
              concepts to conversions
            </span>
          </p>
        </div>

        <img src={digital_marketing_hero_image} alt="" className='digital-marketing-circle' />
      </div>
      ...
      <div className="flex justify-center items-center flex-wrap   my-16">
        {[
          ...
          <p
            key={index}
            className="px-4 py-4 digital-marketing-animated-item hover:text-violet-800 hover:border-violet-800 cursor-pointer text-gray-600 border border-gray-300 rounded-3xl text-xl"
          >
            {text}
          </p>
        ))}
